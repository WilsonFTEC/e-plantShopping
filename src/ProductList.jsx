                ...
                <div style={styleObjUl}>
                    ...
                    <div>
                        <a href="#" onClick={(e) => handleCartClick(e)} style={{ ...styleA, position: 'relative' }}>
                            <h1 className='cart' style={{ position: 'relative', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                    ...
                    {plantsArray.map((category, index) => (
                        <div key={index}>
                            <h1 style={{ textAlign: 'center', margin: '20px 0' }}>
                                <div style={{ display: 'inline-block', borderTop: '2px solid #ccc', borderBottom: '2px solid #ccc', padding: '10px 20px', backgroundColor: '#f0f0f0', fontWeight: 'bold' }}>{category.category}</div>
                            </h1>
